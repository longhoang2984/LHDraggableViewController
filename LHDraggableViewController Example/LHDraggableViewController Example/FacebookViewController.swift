...
import UIKit
import MediaPlayer
import LHDraggableViewController

class FacebookViewController: LHDraggableViewController {
    ...
    override func viewDidLoad() {
        ...
        setupMoviePlayer()
        addObserver(selector: #selector(onOrientationChanged), name: UIDevice.orientationDidChangeNotification.rawValue)
